...
export default function Footer() {
  return (
    <footer className="bg-navy tech-grid-bg">
            ...
            <div className="flex gap-3">
              {certBadges.map((badge) => {
                ...
                return (
                  <div
                    key={badge.name}
                    className="w-10 h-10 rounded-lg bg-navy-light flex items-center justify-center border border-white/10 group hover:border-cyan/30 transition-colors"
                    title={badge.name}
                  >
